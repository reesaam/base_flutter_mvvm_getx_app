...
class AdminTestPage extends CoreView<AdminTestController> {
  ...
  _appPages() => AdminFunctions.sectionGrid(
    items: List.generate(
      ...
      (index) => AppButton.general(text: AppPages.listPages[index].pageName ?? 'Unknown', onTap: () => goToPage(AppPages.listPages[index])),
    ),
    title: 'App All Pages',
  );

  _themes() => AdminFunctions.sectionGrid(
    items: [AdminFunctions.itemButton(text: 'Change Dark Mode', function: controller.changeDarkMode)],
    title: 'Themes',
  );

  _checkConnection() => AdminFunctions.sectionGrid(
    items: [
  ...
  _api() => AdminFunctions.sectionGrid(
    items: [
  ...
  _files() => AdminFunctions.sectionGrid(
    items: [
  ...
  _permissions() => AdminFunctions.sectionGrid(
    items: [
  ...
  _notifications() => Column(
    children: [
      AdminFunctions.sectionGrid(
        items: [
