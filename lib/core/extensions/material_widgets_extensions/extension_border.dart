...
extension ExtensionBorderCopyWith on Border {
  Border copyWith({BorderSide? top, BorderSide? bottom, BorderSide? right, BorderSide? left}) =>
      Border(top: top ?? BorderSide.none, bottom: bottom ?? BorderSide.none, right: right ?? BorderSide.none, left: left ?? BorderSide.none);
}
