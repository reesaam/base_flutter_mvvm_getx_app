...
class HomePage extends CoreView<HomePageController> {
  ...
  @override
  Widget get body => AdaptiveBuilder(
        mobile: (context, layout) => _HomeBody(layout: layout, compact: true),
        tablet: (context, layout) => _HomeBody(layout: layout, compact: false),
        desktop: (context, layout) => _HomeBody(layout: layout, compact: false),
      );
...
class _HomeBody extends StatelessWidget {
  const _HomeBody({required this.layout, required this.compact});
  ...
  Widget build(BuildContext context) {
    final logoHeight = compact ? layout.height / 6 : layout.height / 5;
    return Center(
